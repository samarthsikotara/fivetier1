...
<div class="row-fluid">
    ...
    <div class="span5">
	    ...
	    <p>Visit the <a href="https://sendy.co/api" target="_blank" style="text-decoration:underline">API page</a> to view Sendy's API documentation or explore <a href="https://sendy.co/api#third-party-resources-integrations" target="_blank" style="text-decoration:underline">third party resources and integrations</a>.</p>
    </div>
    <?php endif;?>
</div>
<!-- Validation -->
